<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="GradeManage.Admin.ChangePassword" %>
...
<body>
    ...
    <div class="container">
        ...
        <menu:ChangePwd ID="ChangePwd" runat="server"/>
    </div>
    </form>
</body>
</html>
